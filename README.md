...
iOS events and the first Android measurement request synchronous delivery; later
Android changes are regular events. Android measures after Fabric mounting
