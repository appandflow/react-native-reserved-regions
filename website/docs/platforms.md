...
Later changes are regular events that React receives at a later event beat. If
several changes happen before JavaScript processes them, only the latest is delivered.
